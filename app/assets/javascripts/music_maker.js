$(document).ready(function(){
  ...
  var playCompTriad3 = function(){

    if (inversionType3 === "Random-Inversion"){
      ...
      play(1.5, note2, 0.5, function () {
        $(id(key2Symbol)).addClass("playing");
      });
      play(2, note3, 0.5, function () {
        $(id(key2Symbol)).addClass("playing");
      });
      play(3, note1, 0.5, function () {
        $(id(key2Symbol)).addClass("playing");
      });
      play(3.5, note1, 0.5, function () {
        $(id(key3Symbol)).addClass("playing");
      }, function () {
        // $(id(key1Symbol)).removeClass("playing");
        // $(id(key2Symbol)).removeClass("playing");
    ...
    } else if (inversionType3 === "Third-Inversion"){
  ...
  $("#playCompTriad2").on('click', function(){
    ...
    scaleType = $('#scaleType').val()
    inversionType3 = $('#inversionType3').val();
    console.log(inversionType3);
    ...
    if (inputKey === "f" || inputKey === "f#" || inputKey === "g" || inputKey === "g#"){
      ...
      if (inversionType3 === "Third-Inversion"){
        key2Symbol = (scaleResult[1] + octave)
        key3Symbol = (scaleResult[3] + octave)
      } else{
        key2Symbol = (scaleResult[1] + octave)
        key3Symbol = (scaleResult[3] + octaveUp)
      }
      ...
      // key2 = teoria.note(key2Symbol);
      if (inversionType3 === "Third-Inversion"){
        key3Symbol = (scaleResult[5] + (parseInt(octave) - 1).toString() )
      // key3 = teoria.note(key3Symbol);
    } else{
        key3Symbol = (scaleResult[5] + octave)
      }
    }
